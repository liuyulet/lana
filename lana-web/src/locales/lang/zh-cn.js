export default {
	login: {
		slogan: '高性能 / 精致 / 优雅 / 好玩',
		describe: '基于SpringBoot3.2 + SpringSecurity6.2 + Mybatis-Plus3.5.5 + jwt0.11 + java17 + mysql8 + minio + redis6.2 + swagger3.0 + vue3.2 + vue-router4 + vuex4 + axios + element-plus 的物联网平台。',
		signInTitle: '用户登录',
		accountLogin: '账号登录',
		mobileLogin: '手机号登录',
		rememberMe: '24小时免登录',
