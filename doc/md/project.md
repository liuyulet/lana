...
![ruleqing.png](..%2Fdesign%2Fruleqing.png)
...
![warning.png](..%2Fdesign%2Fwarning.png)
...
功能区包括：删除消息（直接删除即可）、处理预警（可以选择手动填报地址进行预警转发，）

![warningmessage.png](..%2Fdesign%2Fwarningmessage.png)
